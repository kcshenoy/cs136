...
%struct.stack = type { i32, i32, i8* }

@.str = private unnamed_addr constant [2 x i8] c"s\00", align 1
@.str.1 = private unnamed_addr constant [90 x i8] c"/srv/DFSc/cs-teaching/home/u2/areetz/1205-CS136/s20/skeletons/A5/q4c-syntax-check/stack.c\00", align 1
...
@__PRETTY_FUNCTION__.stack_push = private unnamed_addr constant [38 x i8] c"void stack_push(struct stack *, char)\00", align 1
...
@__PRETTY_FUNCTION__.stack_top = private unnamed_addr constant [37 x i8] c"char stack_top(const struct stack *)\00", align 1
@.str.3 = private unnamed_addr constant [15 x i8] c"s->len_cur > 0\00", align 1
@__PRETTY_FUNCTION__.stack_pop = private unnamed_addr constant [31 x i8] c"char stack_pop(struct stack *)\00", align 1
...
if.else:                                          ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i32 0, i32 0), i32 13, i8* getelementptr inbounds ([33 x i8], [33 x i8]* @__PRETTY_FUNCTION__.stack_create, i32 0, i32 0)) #4
  unreachable
...
if.end:                                           ; preds = %if.then
  ...
  %data3 = getelementptr inbounds %struct.stack, %struct.stack* %7, i32 0, i32 2
...
if.else6:                                         ; preds = %if.end
  call void @__assert_fail(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i32 0, i32 0), i32 17, i8* getelementptr inbounds ([33 x i8], [33 x i8]* @__PRETTY_FUNCTION__.stack_create, i32 0, i32 0)) #4
  unreachable
...
; Function Attrs: noinline nounwind optnone
define void @stack_push(%struct.stack* %s, i8 signext %item) #0 {
entry:
  %s.addr = alloca %struct.stack*, align 8
  %item.addr = alloca i8, align 1
  store %struct.stack* %s, %struct.stack** %s.addr, align 8
  store i8 %item, i8* %item.addr, align 1
...
if.else:                                          ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i32 0, i32 0), i32 22, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @__PRETTY_FUNCTION__.stack_push, i32 0, i32 0)) #4
  unreachable
...
if.then1:                                         ; preds = %if.end
  ...
  %9 = load %struct.stack*, %struct.stack** %s.addr, align 8
  %len_max3 = getelementptr inbounds %struct.stack, %struct.stack* %9, i32 0, i32 1
  %10 = load i32, i32* %len_max3, align 4
  %conv = sext i32 %10 to i64
  %mul4 = mul i64 %conv, 4
  %call = call i8* @realloc(i8* %8, i64 %mul4) #3
  %11 = load %struct.stack*, %struct.stack** %s.addr, align 8
  %data5 = getelementptr inbounds %struct.stack, %struct.stack* %11, i32 0, i32 2
  store i8* %call, i8** %data5, align 8
  br label %if.end6

if.end6:                                          ; preds = %if.then1, %if.end
  %12 = load i8, i8* %item.addr, align 1
  %13 = load %struct.stack*, %struct.stack** %s.addr, align 8
  %data7 = getelementptr inbounds %struct.stack, %struct.stack* %13, i32 0, i32 2
  %14 = load i8*, i8** %data7, align 8
  %15 = load %struct.stack*, %struct.stack** %s.addr, align 8
  %len_cur8 = getelementptr inbounds %struct.stack, %struct.stack* %15, i32 0, i32 0
  %16 = load i32, i32* %len_cur8, align 8
  ...
  %len_cur9 = getelementptr inbounds %struct.stack, %struct.stack* %17, i32 0, i32 0
  %18 = load i32, i32* %len_cur9, align 8
...
if.else:                                          ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i32 0, i32 0), i32 32, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @__PRETTY_FUNCTION__.stack_destroy, i32 0, i32 0)) #4
  unreachable
...
if.else:                                          ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i32 0, i32 0), i32 38, i8* getelementptr inbounds ([43 x i8], [43 x i8]* @__PRETTY_FUNCTION__.stack_is_empty, i32 0, i32 0)) #4
  unreachable
...
; Function Attrs: noinline nounwind optnone
define signext i8 @stack_top(%struct.stack* %s) #0 {
entry:
  %s.addr = alloca %struct.stack*, align 8
  store %struct.stack* %s, %struct.stack** %s.addr, align 8
  %0 = load %struct.stack*, %struct.stack** %s.addr, align 8
...
if.else:                                          ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i32 0, i32 0), i32 43, i8* getelementptr inbounds ([37 x i8], [37 x i8]* @__PRETTY_FUNCTION__.stack_top, i32 0, i32 0)) #4
  unreachable
...
if.else2:                                         ; preds = %if.end
  call void @__assert_fail(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i32 0, i32 0), i32 44, i8* getelementptr inbounds ([37 x i8], [37 x i8]* @__PRETTY_FUNCTION__.stack_top, i32 0, i32 0)) #4
  unreachable
...
; Function Attrs: noinline nounwind optnone
define signext i8 @stack_pop(%struct.stack* %s) #0 {
entry:
  %s.addr = alloca %struct.stack*, align 8
  store %struct.stack* %s, %struct.stack** %s.addr, align 8
  %0 = load %struct.stack*, %struct.stack** %s.addr, align 8
...
if.else:                                          ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i32 0, i32 0), i32 49, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__PRETTY_FUNCTION__.stack_pop, i32 0, i32 0)) #4
  unreachable
...
if.else2:                                         ; preds = %if.end
  call void @__assert_fail(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i32 0, i32 0), i32 50, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__PRETTY_FUNCTION__.stack_pop, i32 0, i32 0)) #4
  unreachable
