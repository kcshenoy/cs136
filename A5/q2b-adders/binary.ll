...
%struct.binary = type { i32, i32, i32, i32 }

@.str = private unnamed_addr constant [7 x i8] c"e >= 0\00", align 1
@.str.1 = private unnamed_addr constant [85 x i8] c"/srv/DFSc/cs-teaching/home/u2/areetz/1205-CS136/s20/skeletons/A5/q2b-adders/binary.c\00", align 1
@__PRETTY_FUNCTION__.pow2 = private unnamed_addr constant [14 x i8] c"int pow2(int)\00", align 1
@.str.2 = private unnamed_addr constant [57 x i8] c"0 <= n && n < pow2(sizeof(struct binary) / sizeof(BOOL))\00", align 1
...
if.else:                                          ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([85 x i8], [85 x i8]* @.str.1, i32 0, i32 0), i32 12, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @__PRETTY_FUNCTION__.pow2, i32 0, i32 0)) #4
  unreachable
...
; Function Attrs: noinline nounwind optnone
define { i64, i64 } @binary_make(i32 %n) #0 {
entry:
  %retval = alloca %struct.binary, align 4
...
if.else:                                          ; preds = %land.lhs.true, %entry
  call void @__assert_fail(i8* getelementptr inbounds ([57 x i8], [57 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([85 x i8], [85 x i8]* @.str.1, i32 0, i32 0), i32 24, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__PRETTY_FUNCTION__.binary_make, i32 0, i32 0)) #4
  unreachable

if.end:                                           ; preds = %if.then
  %2 = bitcast %struct.binary* %retval to i8*
  call void @llvm.memset.p0i8.i64(i8* align 4 %2, i8 0, i64 16, i1 false)
  %_0 = getelementptr inbounds %struct.binary, %struct.binary* %retval, i32 0, i32 0
...
for.end:                                          ; preds = %for.cond
  %9 = bitcast %struct.binary* %retval to { i64, i64 }*
  %10 = load { i64, i64 }, { i64, i64 }* %9, align 4
  ret { i64, i64 } %10
}
...
if.else:                                          ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([85 x i8], [85 x i8]* @.str.1, i32 0, i32 0), i32 37, i8* getelementptr inbounds ([45 x i8], [45 x i8]* @__PRETTY_FUNCTION__.binary_to_decimal, i32 0, i32 0)) #4
  unreachable
...
if.end:                                           ; preds = %if.then
  ...
  %add.ptr = getelementptr inbounds i32, i32* %_0, i64 4
...
if.else:                                          ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([85 x i8], [85 x i8]* @.str.1, i32 0, i32 0), i32 50, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @__PRETTY_FUNCTION__.binary_print, i32 0, i32 0)) #4
  unreachable
