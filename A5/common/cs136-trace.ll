...
@.str = private unnamed_addr constant [28 x i8] c">>> cs136tools version 1.1\0A\00", align 1
...
@.str.9 = private unnamed_addr constant [94 x i8] c"/srv/DFSc/cs-teaching/home/u2/areetz/1205-CS136/s20/skeletons/cs136tools/common/cs136-trace.c\00", align 1
...
cond.true:                                        ; preds = %if.then2
  ...
  %call4 = call i8* @strchr(i8* %5, i32 47) #6
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %call5 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %3, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i8* %cond, i8* %7, i32 %8)
  ...
  %call6 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %9, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i32 0, i32 0), i8* %10, i8* %11)
  br label %if.end7
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %call6 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %9, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.3, i32 0, i32 0), i8* %10, i32 %11)
  br label %if.end7
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %call6 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %9, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.4, i32 0, i32 0), i8* %10, i32 %conv)
  br label %if.end7
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %call6 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %9, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.5, i32 0, i32 0), i8* %10, double %11)
  br label %if.end7
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %10 = load i8*, i8** %expstr.addr, align 8
  %11 = load i8*, i8** %expval.addr, align 8
  %call6 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %9, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.6, i32 0, i32 0), i8* %10, i8* %11)
  br label %if.end7
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %10 = load i8*, i8** %expstr.addr, align 8
  %11 = load i8*, i8** %expval.addr, align 8
  %call6 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %9, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.7, i32 0, i32 0), i8* %10, i8* %11)
  br label %if.end7
...
if.else:                                          ; preds = %if.then2
  call void @__assert_fail(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.8, i32 0, i32 0), i8* getelementptr inbounds ([94 x i8], [94 x i8]* @.str.9, i32 0, i32 0), i32 70, i8* getelementptr inbounds ([90 x i8], [90 x i8]* @__PRETTY_FUNCTION__._TRACE_ARR, i32 0, i32 0)) #7
  unreachable
...
if.else7:                                         ; preds = %if.end4
  call void @__assert_fail(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.10, i32 0, i32 0), i8* getelementptr inbounds ([94 x i8], [94 x i8]* @.str.9, i32 0, i32 0), i32 71, i8* getelementptr inbounds ([90 x i8], [90 x i8]* @__PRETTY_FUNCTION__._TRACE_ARR, i32 0, i32 0)) #7
  unreachable
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %call11 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %5, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i8* %cond, i8* %9, i32 %10)
  %11 = load %struct._IO_FILE*, %struct._IO_FILE** @_tracing_out, align 8
  %12 = load i8*, i8** %expstr.addr, align 8
  %call12 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %11, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.11, i32 0, i32 0), i8* %12)
...
if.then15:                                        ; preds = %for.body
  ...
  %call16 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %16, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.12, i32 0, i32 0))
  br label %if.end17

if.end17:                                         ; preds = %if.then15, %for.body
  %17 = load i8*, i8** %type.addr, align 8
  %call18 = call i32 @strcmp(i8* %17, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.13, i32 0, i32 0)) #6
...
if.then20:                                        ; preds = %if.end17
  ...
  %call21 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %18, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.14, i32 0, i32 0), i32 %22)
  br label %if.end60

if.else22:                                        ; preds = %if.end17
  %23 = load i8*, i8** %type.addr, align 8
  %call23 = call i32 @strcmp(i8* %23, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.15, i32 0, i32 0)) #6
...
if.then25:                                        ; preds = %if.else22
  ...
  %call28 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %24, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.16, i32 0, i32 0), i32 %conv)
  br label %if.end59

if.else29:                                        ; preds = %if.else22
  %28 = load i8*, i8** %type.addr, align 8
  %call30 = call i32 @strcmp(i8* %28, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.17, i32 0, i32 0)) #6
...
if.then32:                                        ; preds = %if.else29
  ...
  %call35 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %29, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.18, i32 0, i32 0), double %33)
  br label %if.end58

if.else36:                                        ; preds = %if.else29
  %34 = load i8*, i8** %type.addr, align 8
  %call37 = call i32 @strcmp(i8* %34, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.19, i32 0, i32 0)) #6
...
if.then39:                                        ; preds = %if.else36
  ...
  %cond44 = select i1 %tobool42, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.21, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.22, i32 0, i32 0)
  %call45 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %35, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.20, i32 0, i32 0), i8* %cond44)
  br label %if.end57

if.else46:                                        ; preds = %if.else36
  %40 = load i8*, i8** %type.addr, align 8
  %call47 = call i32 @strcmp(i8* %40, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.23, i32 0, i32 0)) #6
...
if.then49:                                        ; preds = %if.else46
  ...
  %call53 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %41, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.20, i32 0, i32 0), i8* %call52)
  br label %if.end56

if.else54:                                        ; preds = %if.else46
  %46 = load %struct._IO_FILE*, %struct._IO_FILE** @_tracing_out, align 8
  %47 = load i8*, i8** %type.addr, align 8
  %call55 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %46, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.24, i32 0, i32 0), i8* %47)
  br label %if.end62
...
for.end:                                          ; preds = %for.cond
  ...
  %call61 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %49, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.25, i32 0, i32 0))
  br label %if.end62
