...
// stack_print(stck, dir) prints the items on stck, with dir either
//   FRONT_TO_BACK (top to bottom) or BACK_TO_FRONT (bottom to top).
// effect: prints to the console
// time O(n)
void stack_print(const struct stack *stck, int dir);